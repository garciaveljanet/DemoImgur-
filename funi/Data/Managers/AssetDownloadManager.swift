...
extension AssetDownloadManager: URLSessionDownloadDelegate {
    ...
    func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask, didFinishDownloadingTo location: URL) {
        ...
        do {
            ...
            assetDownloadItem.completionHandler?(.fail(APIError.invalidData))
        }
    ...
    func urlSession(_ session: URLSession, task: URLSessionTask, didCompleteWithError error: Error?) {
        ...
        guard let error = error else {
            assetDownloadItem.completionHandler?(.fail(APIError.unknown))
            return
        }
        
        assetDownloadItem.completionHandler?(.fail(error))
